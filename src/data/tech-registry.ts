...
'Analyse des besoins': { color: '#FF1493' },
  ...
  'Functional and technical requirements analysis': { color: '#FF4D4D' },
  'Technical documentation writing': { color: '#FF8C00' },
  'Risk management': { color: '#4D96FF' },
  'Analytical thinking': { color: '#00C2FF' },
  'Autonomy': { color: '#7C4DFF' },
  'Problem solving': { color: '#00E676' },
  'Project tracking': { color: '#FF2DAA' },
  'Attention to detail': { color: '#FF6F00' },
  'Commitment and ownership': { color: '#FF1744' },
  'Team collaboration and cohesion': { color: '#FFBE0B' },
  'Teamwork': { color: '#FF1493' },
  'Adaptability/Flexibility': { color: '#A6FF00' },
  'Time management': { color: '#00D4FF' },
  'Collaboration et cohésion d’équipe': { color: '#5E60CE' },
  'Adaptabilité': { color: '#FF1493' },
