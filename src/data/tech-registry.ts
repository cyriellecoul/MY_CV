...
const TECH_REGISTRY = {
  ...
  'Analyse des besoins TI': { color: '#FF6D00' },
  'Communication avec les parties prenantes': { color: '#00E676' },
  'Cycle de vie du développement logiciel (SDLC)': { color: '#0077B6' },
 'Intégration de systèmes': { color: '#FF4D00' },
